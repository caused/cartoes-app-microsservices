...
public class MastertechExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler({CartaoNaoPertenceException.class})
	public ResponseEntity<Object> handleEmptyResultDataAccessException(CartaoNaoPertenceException ex, WebRequest request){
